...
| Bestiary | The Core Rulebook's named Extras (about 70), with skills, spells, and items, and portraits and tokens taken from the book's illustrations (47 of them); tokens are friendly, neutral, or hostile to match how the book presents each character. |
